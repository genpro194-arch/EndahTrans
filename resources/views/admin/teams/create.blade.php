...
@section('title', 'Tambah Tim Profesional - Admin')
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-extrabold text-gray-900">Tambah Tim Profesional</h1>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-lg shadow">
            <form action="{{ route('admin.teams.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
